...
class TestTextUtils(TestCase):
    ...
    def test_center_text(self):
        ...
        self.assertEqual(expects, TextUtils.center_text('Text Center Alignment Example'))
    ...
    def test_text_format(self):
        ...
        actual = TextUtils.text_format(text, bold_italics_code='bci', color='red', align='center')
    ...
    def test_add_tooltip(self):
        ...
        self.assertEqual(expects, TextUtils.add_tooltip(link='https://link.com', tip='tooltip'))
